...
function Shop() {
  ...
  <div className="bg-black min-h-screen text-white px-6 md:px-16 pt-4 pb-16">
    ...
    <div className="mb-3">
      ...
      <p className="text-zinc-500 text-lg">Discover premium fashion collections</p>
    </div>
    ...
    <div className="flex flex-col lg:flex-row items-start gap-8">
      ...
      <div className="w-full lg:w-[280px] shrink-0">
        ...
        ">
          {/* SEARCH */}
          <div>
            <p className="text-xs uppercase tracking-[4px] text-zinc-500 mb-2">Search</p>
            <input
              type="text"
          ...
          {/* CATEGORY */}
          <div>
            <p className="text-xs uppercase tracking-[4px] text-zinc-500 mb-2">Category</p>
            <select
              value={category}
          ...
          {/* SORT */}
          <div>
            <p className="text-xs uppercase tracking-[4px] text-zinc-500 mb-2">Sort By</p>
            <select
              value={sort}
          ...
          <div>
            <div className="flex justify-between mb-2">
              <p className="text-xs uppercase tracking-[4px] text-zinc-500">Price</p>
      ...
      <div className="flex-1">
        ...
        <div className="flex justify-between items-center mb-3">
          <p className="text-zinc-500 text-sm">{filteredProducts.length} Products Found</p>
        </div>
            ...
            return (
              <div
                ...
                className="
                  ...
                  rounded-3xl overflow-hidden hover:border-zinc-700 transition
                "
              >
                  ...
                  <div className="mt-5">
                    {quantity > 0 ? (
                      ...
                      <button
                        ...
                        className="bg-white text-black px-5 py-3 rounded-xl font-semibold w-full"
                      >
                        Add To Cart
                      </button>
                    )}
